...
function about_star(about){
			                         
		  var a_c =  Math.floor(Math.random() * 5) + 1;
    for (var i = 1; i <= 5; i++) {
	c_name = i.toString()+"-star";
	if( i <= a_c){
		about =  insertProperty(about, c_name, "fa fa-star");
		
	}
	else{
				about =  insertProperty(about, c_name,"fa fa-star-o");
  ...
  about = insertProperty(about, "stars", a_c.toString());
...
dc.loadAbout = function(){
	showLoading("#main-content");
        ...
        $ajaxUtils.sendGetRequest(about, 
        function(about){
					  switchAboutToActive();

            
	
                insertHtml("#main-content", about_star(about) );
            },
            false);
    }
